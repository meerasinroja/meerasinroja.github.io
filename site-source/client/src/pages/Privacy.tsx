...
export default function Privacy() {
  return (
    <div className="min-h-screen bg-[#faf8f5]">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-[#faf8f5]/90 backdrop-blur-md border-b border-[#2a2a2a]/5">
        <div className="container flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-2 text-[#2a2a2a] hover:text-[#c17f4a] transition-colors">
            <ArrowLeft className="w-4 h-4" />
            <span className="font-bold text-lg" style={{ fontFamily: "'Playfair Display', serif" }}>
              <span className="text-[#2a2a2a]">Meera</span>
              <span className="text-[#c17f4a]">Social</span>
            </span>
          </Link>
        </div>
      </header>
      ...
      <main className="container py-16 md:py-24 max-w-3xl">
        <h1 className="text-4xl md:text-5xl font-bold text-[#2a2a2a] mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
          Privacy Policy
        </h1>
        <p className="text-[#2a2a2a]/50 mb-12">Last updated: June 04, 2026</p>

        <div className="prose prose-lg max-w-none text-[#2a2a2a]/80 space-y-6">
          <p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
          <p>We use Your Personal Data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.</p>

          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Interpretation and Definitions</h2>
          
          <h3 className="text-xl font-bold text-[#2a2a2a] mt-8 mb-3">Interpretation</h3>
          <p>The words whose initial letters are capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>

          <h3 className="text-xl font-bold text-[#2a2a2a] mt-8 mb-3">Definitions</h3>
          <p>For the purposes of this Privacy Policy:</p>
          <ul className="list-disc pl-6 space-y-3">
            <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
            <li><strong>Affiliate</strong> means an entity that controls, is controlled by, or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
            <li><strong>Application</strong> refers to BrandHub Pro, the software program provided by the Company.</li>
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Meera Social LLC.</li>
          ...
          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Collecting and Using Your Personal Data</h2>
          
          <h3 className="text-xl font-bold text-[#2a2a2a] mt-8 mb-3">Types of Data Collected</h3>
          
          <h4 className="text-lg font-semibold text-[#2a2a2a] mt-6 mb-2">Personal Data</h4>
          <p>While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:</p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Email address</li>
          </ul>

          <h4 className="text-lg font-semibold text-[#2a2a2a] mt-6 mb-2">Usage Data</h4>
          ...
          <h3 className="text-xl font-bold text-[#2a2a2a] mt-8 mb-3">Use of Your Personal Data</h3>
          ...
          <h3 className="text-xl font-bold text-[#2a2a2a] mt-8 mb-3">Retention of Your Personal Data</h3>
          ...
          <h3 className="text-xl font-bold text-[#2a2a2a] mt-8 mb-3">Transfer of Your Personal Data</h3>
          ...
          <h3 className="text-xl font-bold text-[#2a2a2a] mt-8 mb-3">Delete Your Personal Data</h3>
          ...
          <h3 className="text-xl font-bold text-[#2a2a2a] mt-8 mb-3">Disclosure of Your Personal Data</h3>
          
          <h4 className="text-lg font-semibold text-[#2a2a2a] mt-6 mb-2">Business Transactions</h4>
          <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
          
          <h4 className="text-lg font-semibold text-[#2a2a2a] mt-6 mb-2">Law Enforcement</h4>
          <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
          
          <h4 className="text-lg font-semibold text-[#2a2a2a] mt-6 mb-2">Other Legal Requirements</h4>
          ...
          <h3 className="text-xl font-bold text-[#2a2a2a] mt-8 mb-3">Security of Your Personal Data</h3>
          ...
          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Children's Privacy</h2>
          ...
          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Links to Other Websites</h2>
          <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
          <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>

          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Changes to this Privacy Policy</h2>
          <p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.</p>
          <p>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the "Last updated" date at the top of this Privacy Policy.</p>
          <p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>

          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Contact Us</h2>
          <p>If you have any questions about this Privacy Policy, You can contact us:</p>
          <ul className="list-disc pl-6 space-y-2">
            <li>By email: meera1710@gmail.com</li>
          </ul>
        </div>
      </main>

      {/* Terms & Conditions */}
      <section className="container py-16 md:py-24 max-w-3xl border-t border-[#2a2a2a]/10">
        <h1 className="text-4xl md:text-5xl font-bold text-[#2a2a2a] mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
          Terms and Conditions
        </h1>
        <p className="text-[#2a2a2a]/50 mb-12">Last updated: June 13, 2026</p>
        ...
        <div className="prose prose-lg max-w-none text-[#2a2a2a]/80 space-y-6">
          ...
          <ul className="list-disc pl-6 space-y-3">
            <li><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named BrandHub Pro</li>
            ...
            <li><strong>Affiliate</strong> means an entity that controls, is controlled by, or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
            <li><strong>Country</strong> refers to: California, United States</li>
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to Meera Social LLC.</li>
            <li><strong>Device</strong> means any device that can access the Service such as a computer, a cell phone or a digital tablet.</li>
            ...
            <li><strong>Website</strong> refers to Meera Social, accessible from <a href="https://www.meerasocial.com/" className="text-[#c17f4a] hover:underline">https://www.meerasocial.com/</a></li>
            <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
          </ul>

          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Acknowledgment</h2>
          ...
          <h3 className="text-xl font-bold text-[#2a2a2a] mt-8 mb-3">Links from a Third-Party Social Media Service</h3>
          ...
          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Termination</h2>
          <p>We may terminate or suspend Your access immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms and Conditions.</p>
          <p>Upon termination, Your right to use the Service will cease immediately.</p>

          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Limitation of Liability</h2>
          ...
          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>"AS IS" and "AS AVAILABLE" Disclaimer</h2>
          ...
          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Governing Law</h2>
          ...
          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Disputes Resolution</h2>
          <p>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</p>

          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>For European Union (EU) Users</h2>
          <p>If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident.</p>

          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>United States Legal Compliance</h2>
          <p>You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p>

          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Severability and Waiver</h2>
          <h3 className="text-xl font-bold text-[#2a2a2a] mt-8 mb-3">Severability</h3>
          <p>If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.</p>
          <h3 className="text-xl font-bold text-[#2a2a2a] mt-8 mb-3">Waiver</h3>
          <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>

          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Translation Interpretation</h2>
          <p>These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.</p>

          <h2 className="text-2xl font-bold text-[#2a2a2a] mt-12 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>Changes to These Terms and Conditions</h2>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>By email: meera@meerasocial.com</li>
          </ul>
        </div>
      </section>

      {/* Footer */}
      <footer className="py-8 border-t border-[#2a2a2a]/5">
        <div className="container text-center">
          <p className="text-[#2a2a2a]/40 text-sm">&copy; 2026 Meera Social LLC. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
